...
import { IdeleteUserInputDTO, IGetUsersInputDTO, IGetUsersOutputDTO, IGetUsersOutputUsers, ILoginInputDTO, ISignupInputDTO, User, USER_ROLES } from "../models/User"
...
export class UserBusiness {
    ...
    public getUsers = async (input: IGetUsersInputDTO) => {
        ...
        const users = usersDB.map(userDB => {
            ...
            const userResponse: IGetUsersOutputUsers = {
                id: user.getId(),
                name: user.getName(),
                email: user.getEmail()
            }
